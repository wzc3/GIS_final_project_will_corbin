...
Null hypothesis:
The likelihood that an Union victory occurs at the given point _s~i~_ is directly proportional to the density of railroad junctions at that point.

Alternative hypothesis:
There exists a population density threshold _p^*_ such that Union victories occur at locations _s~i~^*_ with railroad junction density greater than _p^*_ more often than what would be expected solely on the basis of this railroad junction density.
